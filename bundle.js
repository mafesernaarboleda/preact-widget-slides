 ...
 */
var collectPropsFromElement = function collectPropsFromElement(element) {
 ...
 */
var preact_habitat_es__render = function _render(widget, hostElements, root, cleanRoot) {
  ...
  var render = function render(ref) {
    ...
    var loaded = function loaded() {
      if (elements.length > 0) {
        ...
        return preact_habitat_es__render(widget, elements$1, root, clean);
      }
    };
    loaded();
...
var style = __webpack_require__("gp30");
...
/* harmony default export */ var components_item = (function (props) {
    ...
    return Object(preact_min["h"])(
        'div',
        { 'class': style_default.a.item },
        Object(preact_min["h"])(
            'a',
            { href: 'https://slides.com' + url, target: '_blank' },
            Object(preact_min["h"])('img', { src: imageUrl })
        )
    );
});
// EXTERNAL MODULE: ./components/style.scss
var components_style = __webpack_require__("xs7b");
...
/* harmony default export */ var api = ((function () {
    var _ref = _asyncToGenerator(function* (user) {
        return new Promise(function (resolve, reject) {
            fetch("https://scrapp-slide.herokuapp.com/api/scrap/find/" + user).then(function () {
                ...
                return reject(JSON.parse(error.message));
            });
        });
    });
...
// CONCATENATED MODULE: ./components/widget.js
...
var widget_Widget = function (_Component) {
  ...
  Widget.prototype.componentWillMount = function componentWillMount(props) {
    var _this2 = this;

    api(this.props.user).then(function (res) {
      return _this2.setState({ slides: res });
    });
  };

  Widget.prototype.render = function render(props, state) {
    return Object(preact_min["h"])(
      'div',
      { 'class': components_style_default.a.container },
      Object(preact_min["h"])(
        'div',
        { 'class': components_style_default.a.carousel },
        state.slides.map(function (item) {
          return Object(preact_min["h"])(components_item, { item: item });
        })
      )
    );
  };
...
var _habitat = preact_habitat_es(widget_Widget);
...
module.exports = {"item":"item__6Yvhi"};
...
// removed by extract-text-webpack-plugin
module.exports = {"carousel":"carousel__2q0Xh","container":"container__CYvN_"};
